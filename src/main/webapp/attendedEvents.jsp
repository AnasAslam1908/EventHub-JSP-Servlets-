...
<%
    ...
    List<Event> attendedEvents = userService.getAttendedEvents(loggedInUser.getUserId());
...
<div class="container event-container">
    <h2 class="text-center">Your Attended Events</h2>
        ...
        <div class="col-md-4">
            <div class="card event-card">
                <div class="card-body">
                    ...
                    <a href="submitFeedback.jsp?eventId=<%= event.getEventId() %>" class="btn btn-primary ">Submit Feedback</a>
                </div>
            </div>
        </div>
        <%
